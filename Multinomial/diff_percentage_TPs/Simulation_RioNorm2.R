## Apply RioNorm2 on Multinomial-based simulation data
## with different percentage of DA-OTUs
...
hknorm_2stage_test <- function(OTU_table) {
  ...
  # Step 1: find RiOTUs
  size_factor = hk_find_simulation(OTU_table, min_avg_counts = 5, q = 0.03)$size_factor
...
save(RioNorm2list, file = "RioNorm2reslist_diff_percentage_nTPs_small_effectsize_ns_5000_nsamples_25.RData")
